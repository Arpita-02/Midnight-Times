...
from advarisk.users.views import CustomLoginView
...
urlpatterns = [
    ...
    # User management
    path("newsapp/", include("advarisk.newsapp.urls")),
    path("users/", include("advarisk.users.urls", namespace="users")),
    ...
    # path('auth/registration/', include('dj_rest_auth.registration.urls')),  # dj-rest-auth registration
